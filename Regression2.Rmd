...
# we also think the hospital beds would be correlated with the total population, suggesting county with more population would have more beds
# finally, we want to know if race variables are significant in this analysis, thereby we added all race variables to check their relationship with the number of beds
